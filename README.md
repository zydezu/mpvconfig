...
| [mpvcut]([https://github.com/b1scoito/mpv-cut](https://github.com/familyfriendlymikey/mpv-cut)) allows clipping a segment of a video | **z** - Mark start segment <br> **z (again)** - Clip the video <br> **a** - Change mode (copy, encode, compress) |
