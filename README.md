...
| [detectdualsubs](https://github.com/zydezu/mpvconfig/blob/main/scripts/detectdualsubs.lua) Allows multiple audio tracks to be selected and played together | **Ctrl+z** - Toggle another audio track |
